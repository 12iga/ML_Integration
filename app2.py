...
'Tidak']),
    ...
    'loan_amount_term': st.selectbox('Jangka Waktu Pinjaman (bulan)', [12.0, 36.0, 60.0, 84.0, 120.0, 180.0, 240.0,
300.0, 360.0, 480.0]),
'credit_history': st.selectbox('Riwayat Kredit (1 jika ada, 0 jika tidak)', [0.0, 1.0]),'property_area': st.selectbox('Area Properti', ['Pedesaan', 'Semiurban', 'Perkotaan']),
}
